...
{
	public class SquareBrushToolHandle : ITilemapToolHandle
	{
		...
		public SquareBrushToolHandle(Action<IEnumerable<Vector3Int>> select, Action<IEnumerable<Vector3Int>> draw, Action<IEnumerable<Vector3Int>> erase)
		{
			Select = select;
			Draw = draw;
			Erase = erase;
