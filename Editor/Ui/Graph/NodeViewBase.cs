...
using LemonInc.Editor.Utilities.Ui.Graph.GraphNode;
...
namespace LemonInc.Editor.Utilities.Ui.Graph
{
	...
	public abstract class NodeViewBase<TNodeData> : Node, INodeView<TNodeData> 
		where TNodeData : class, INode
	{
		...
		/// </value>
		public Action<TNodeData> OnSelectedEvent { get; set; }
		...
		/// </value>
		public Action<TNodeData> OnUnSelectedEvent { get; set; }
