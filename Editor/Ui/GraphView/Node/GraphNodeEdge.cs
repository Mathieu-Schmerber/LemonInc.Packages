...
namespace LemonInc.Core.Utilities.Editor.Ui.GraphView.Node
{
	/// <summary>
	...
	public class GraphNodeEdge : EdgeView
	{
        ...
        {
	        var triangle = AssetDatabase.LoadAssetAtPath<Sprite>($"Packages/com.lemon-inc.core.utilities/{TRIANGLE_PATH}") ??
